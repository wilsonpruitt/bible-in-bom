...
const S: Record<string, CSSProperties> = {
  ...
  credit: { fontSize: 11, color: `${P.inkMuted}`, margin: "10px 0 0", letterSpacing: 1.5 },
  ...
  sourceSection: { borderTop: `1px solid ${P.rule}`, paddingTop: 12, marginTop: 8 },
  sectionLabel: {
    fontFamily: "'Cormorant Garamond', serif",
    fontSize: 13,
    fontWeight: 600,
  ...
  chapterNav: { borderTop: `1px solid ${P.rule}`, paddingTop: 14, marginTop: 14 },
  ...
  chapterHead: { marginBottom: 20, paddingBottom: 10, borderBottom: `1px solid ${P.rule}` },
  chapterNum: {
    fontFamily: "'Cormorant Garamond', serif",
    fontSize: 24,
    fontWeight: 600,
  ...
  whyNot: {
    marginTop: 12,
    paddingTop: 10,
    borderTop: `1px solid ${P.warnSoft}`,
  },
  bibliography: {
    fontFamily: "'Crimson Pro', Georgia, serif",
    fontSize: 11.5,
